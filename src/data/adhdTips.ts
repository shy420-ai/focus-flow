...
export const ADHD_TIPS: AdhdTip[] = [
  ...
  {
    id: 'rude-delay-trap',
    title: '무례한 말 받아주고 자기혐오 올 때',
    category: 'social',
    summary: '몸 신호 + 외운 멘트 + 가라앉은 후 다시 말하기.',
    addedAt: '2026-05-03',
    sections: [
      { icon: '😔', title: '문제', body: '무례한 말이 들어오면 어색하게 웃고 받아넘기는데, 몇 시간 후 자기혐오가 몰려옵니다.\n그 자리에선 머리가 멈추고, 다음에 또 같은 패턴.\nADHD + 충동성 = "빠른 반응"과 "좋은 반응" 둘 중 하나만 골라야 하는데, 사회 규범 때문에 받아주는 쪽 자동 선택.\n나중 후회는 깊고 오래 갑니다.' },
      { icon: '💡', title: '해결', body: '3단계 — 알아채기 + 끊기 + 시간차 회복.\n1) 몸 신호로 알아채기 (머리는 늦음)\n2) 외운 한 마디로 그 자리에서 끊기\n3) 못 끊었으면 = 감정 가라앉은 후 다시 말하기 (그 자리 X 도 OK)\n그 자리에서 못 한 게 = 약함이 아니라, 가라앉은 후가 = 더 정확하고 강합니다.' },
      { icon: '🎯', title: '예시', body: '• 몸 신호 4가지: 어깨 굳음 / 미소 어색해짐 / 가슴 빠르게 뜀 / 손에 힘\n• 외워둘 멘트 1개: "어, 잠깐. 그건 좀 그렇다."\n• 안 나오면 = 자리 뜨기 ("화장실 잠깐", "전화 받을게")\n\n• 놓쳤을 때 = 가라앉은 후 다시 말하기 (가장 실용)\n  - 1시간~24시간 안에 카톡: "어제 OO 한 말은 좀 불편했어. 다음엔 안 그랬으면 해."\n  - 직접: "어제 그 말 좀 마음에 걸려서, 짧게 얘기하고 싶어"\n  - 짧게·구체적으로·욕 X·"다음엔 안 그랬으면" 으로 끝\n\n• 자주 보는 무례한 사람 (가족·동료) = 멘트 미리 외워가기\n• 친한 사람한테 미리 = "나 무례에 잘 못 받아쳐" 알리기 → 옆에서 잘라줌\n• 스벅·택배기사 = 작은 거절 연습 ("빨대 안 주셔도 돼요") → 거절 근육 만들기\n• 자기혐오 올 때 = "내가 약한 게 아니라 1초 윈도우 알아챈 것" 1줄 메모\n• 같은 사람 반복 = 거리 두기 신호 (혼자 안 됨 = 환경 바꾸기)' },
    ],
    source: 'HSP boundary practice; assertiveness training research',
    tags: ['관계', '경계', '자기혐오'],
  },
  // ── 💼 업무 (추가 2026-05-03) ──────────────────────
  {
    id: 'work-email-overload',
    title: '메일함 800통 — 열기조차 무서울 때',
    category: 'work',
    summary: 'inbox zero ❌ → "지금 답할 5개" 만 골라 끝.',
    addedAt: '2026-05-03',
    sections: [
      { icon: '😔', title: '문제', body: '메일함 800통 = "답해야 할 게 너무 많아" → 열기조차 못 함.\n다 답하려는 강박 → 결국 1통도 못 답 → 더 쌓임.\n중요·긴급한 게 묻힘 → 진짜 일 놓침.\n이메일 회피가 = 직장 ADHD에서 가장 흔한 번아웃 트리거.' },
      { icon: '💡', title: '해결', body: '"inbox zero" 강박 버리기. 실제 답할 가치 있는 건 5~10%.\n2번 정해진 시간만 메일 (오전 11·오후 4시). 그 외엔 알림 X.\n각 메일 = 4D 한 번 결정: Delete · Delegate · Defer · Do (5분).\n5분 안 끝날 거 = "오늘 할 일" 노트로 옮기고 메일창 닫기.' },
      { icon: '🎯', title: '예시', body: '• 메일 알림 = OFF (앱·푸시·소리 다)\n• 시간 = 11:00 / 16:00 두 번만 정해놓기\n• 한 메일 = 30초 안에 4D 결정\n  - Delete = 광고·뉴스레터·CC만\n  - Delegate = 다른 사람 일이면 한 줄 forward + 끝\n  - Defer = 답장 필요하지만 5분 ↑ = "오늘 할 일" 노트로\n  - Do = 5분 안 끝낼 수 있으면 그 자리에서\n• 800통 누적된 거 = 읽음 처리 X = "Select all → Archive" 한 번에\n• 정말 중요한 거면 다시 보내옴 (90% 룰)\n• 매일 아침 메일 X = 오전 1시간은 진짜 일 먼저\n• 자동 회신 = "확인 후 24시간 안에 답합니다" 설정\n• 답장 길어지면 = 음성 메모 → 텍스트 변환 (클로바노트)' },
    ],
    source: 'GTD methodology; Cal Newport "A World Without Email"',
    tags: ['업무', '메일'],
  },
  {
    id: 'work-time-blindness',
    title: '시간 추정이 매번 망할 때',
    category: 'work',
    summary: '"30분이면 돼요" 절대 ❌ → 평소 X 1.5~2배.',
    addedAt: '2026-05-03',
    sections: [
      { icon: '😔', title: '문제', body: '"이거 30분이면 돼요" → 실제 3시간. 매번.\nADHD time blindness = 미래 시간을 객관적으로 예측 못 함.\n결과 = 마감 어김 + 다른 일정 도미노로 망가짐 + 신뢰 ↓.\n매번 본인도 놀람 — "왜 이렇게 오래 걸렸지?".' },
      { icon: '💡', title: '해결', body: '본인 추정 시간 X 1.5~2배 = 진짜 견적.\n과거 데이터 = 매번 같은 일 시간 기록 → 평균치 사용.\n약속할 땐 = 견적 + 버퍼 30%. "30분" 으로 약속 X.\n한 일 시작 전 = 알람 정확히 추정 시간 만큼 (실측).' },
      { icon: '🎯', title: '예시', body: '• 본인 추정 = 30분 → 견적 = 60~90분으로 답하기\n• Toggl·Clockify·Apple 시계 활용 = 한 일 시작·끝 자동 기록\n• 같은 일 5번 = 평균 = 진짜 견적\n• 회의 = "30분"으로 잡았어도 = 다음 1시간 비워두기\n• 마감 약속 = "수요일까지" → "다음 주 수요일까지" 로 한 단계 올리기\n• 장 보기·집안일도 같은 룰 적용 (사회 일정)\n• 시간 블록 = "이 일에 90분 쓴다" 의식적 정함\n• 90분 안에 못 끝나면 = 그 자체로 데이터 ("이건 더 걸리는 일")\n• ADHD 친구한테 = "내 시간 견적 1.5배" 같이 약속하면 서로 인정' },
    ],
    source: 'Russell Barkley time blindness research; ADHD coaching practice',
    tags: ['업무', '시간', '추정'],
  },
  {
    id: 'work-job-change-decide',
    title: '이직 결정 못 하고 1년째 고민할 때',
    category: 'work',
    summary: '리스트 X → 24시간 결정 + 작은 행동 1개부터.',
    addedAt: '2026-05-03',
    sections: [
      { icon: '😔', title: '문제', body: '"이 회사 그만둬야 하나" 1년째 머리 속에서만 회전.\n장단점 리스트 100번 만들었지만 = 결정 X.\nADHD 결정 마비 + RSD ("실패하면 어쩌지") + time blindness ("나중에 결정") = 영원히 미룸.\n결국 = 회사 분위기 더 나빠진 후에야 떠밀려서 그만둠.' },
      { icon: '💡', title: '해결', body: '큰 결정을 작고 reversible 한 1개 행동으로 쪼개기.\n"이직" 결정 X → "이력서 1줄 갱신" 부터.\n각 단계 = 언제든 멈출 수 있음. 부담 ↓.\n움직이면서 정보 수집 → 결정이 자연스럽게 됨.' },
      { icon: '🎯', title: '예시', body: '• 1단계: 이력서 1줄만 갱신 (5분)\n• 2단계: LinkedIn 사진 갱신 (10분)\n• 3단계: 관심 회사 1군데 채용 페이지 보기 (15분)\n• 4단계: 친구 1명한테 이직 고민 말하기\n• 5단계: 1군데 지원 (50% 마음만 있어도 OK)\n• 6단계: 면접 1번 보기 (합격해도 안 가도 OK)\n• 합격 받으면 = 비교할 수 있는 객관 자료 생김\n• 6개월 시한 정하기 = "안에 행동 안 하면 = 안 그만두는 거" 라고 명확화\n• 동전 던지기 → 결과 보고 안도/실망 = 진짜 마음\n• 자기혐오 X — 결정 안 하는 것도 = 결정의 한 종류' },
    ],
    source: 'Bezos two-way door decisions; ADHD decision-making research',
    tags: ['업무', '이직', '결정'],
  },
  {
    id: 'work-doc-blank-page',
    title: '보고서·기획서 첫 줄에서 막힐 때',
    category: 'work',
    summary: '제목·서론 X → 결론·예시부터 거꾸로.',
    addedAt: '2026-05-03',
    sections: [
      { icon: '😔', title: '문제', body: '"기획서 작성" 시작 = 빈 페이지 + 깜빡이는 커서 = 멍.\n제목·서론·"개요" 먼저 쓰려다 = 30분 동안 한 줄도 X.\nADHD + 완벽주의 = 첫 줄이 가장 어려움.\n결국 = 마감 새벽까지 남기고 벼락치기.' },
      { icon: '💡', title: '해결', body: '거꾸로 쓰기: 결론 → 예시 → 본문 → 서론 → 제목.\n글의 모양 = 마지막 한 페이지부터.\n예시·데이터·자료 = 제일 쉬움 → 모아두면 본문 자연스레 나옴.\n첫 줄·제목 = 쓰기 가장 어려움 → 마지막에 다듬기.' },
      { icon: '🎯', title: '예시', body: '• 1단계: 빈 문서 열기 → 결론 1문장 (예: "X 캠페인 결과 N% 도달")\n• 2단계: 그 결론 뒷받침할 데이터·예시 5개 적기 (글 X 메모 형식)\n• 3단계: 그 5개 사이를 잇는 본문 한 단락씩\n• 4단계: 본문 다 쓰면 = 서론 = "이 글이 무엇 다룰지" 1단락\n• 5단계: 마지막에 제목 = 결론·서론 본 후에 가장 좋은 것\n• 음성 입력 = 처음 시작 마찰 ↓ (말이 더 쉬움)\n• 다른 자료 보면서 = "이거 인용" 메모 → 본인 글에 자연스레 들어옴\n• 못 쓰겠으면 = 친구한테 말로 설명 → 녹음 → 텍스트 변환 → 다듬기\n• 마감 1주 전 = 매일 30분만 작성 (벼락치기 방지)\n• 첫 draft = "60% 짜리" 라고 자기한테 허락. 나중에 다듬기' },
    ],
    source: 'Pyramid Principle (Barbara Minto); ADHD writing block coping',
    tags: ['업무', '글쓰기'],
  },
  {
    id: 'work-drinking-meds',
    title: '회식 술자리 — 약 먹고 술 마셔야 할 때',
    category: 'work',
    summary: '거절 멘트 + 마셔야 하면 양 ↓ + 다음날 약은 평소대로.',
    addedAt: '2026-05-03',
    sections: [
      { icon: '😔', title: '문제', body: '회식·술자리 = 거절 어려움.\nADHD 약 (자극제·항우울제·기분안정제) + 술 = 부작용 위험 ↑.\n자극제 + 술 = 술기운 마스킹 → 과음 위험 + 심혈관 부담.\n항우울제 + 술 = 다음날 우울감 ↑↑.\n약 안 먹고 마시면 = 다음날 약 시간 헷갈리고 회복 어려움.' },
      { icon: '💡', title: '해결', body: '거절 멘트 미리 외우기 — 회식 = 가기 전에 결정.\n안 마시는 옵션 = "건강 검진 결과 낮춰야 해서요" / "약 때문에" 둘 다 효과.\n마셔야 하면 = 평소 양의 절반 + 천천히 + 물 같이 + 식사 충분히.\n다음날 약 = 평소대로 (식사 후) — 약 거르면 회복 더 늦어짐.' },
      { icon: '🎯', title: '예시', body: '• 거절 멘트 (외우기): "약 때문에 오늘은 무알콜로 갈게요"\n• 더 강한 멘트: "건강 검진 결과 술 줄이라 해서요"\n• 무알콜 옵션: 무알콜 맥주·콤부차·탄산수 (분위기는 유지)\n• 마실 거면: 자극제 복용일 = 평소의 1/2, 천천히, 한 잔 사이 물 1잔\n• 빈 속 X = 회식 가기 전 = 단백질 식사 (술 흡수 ↓)\n• 항우울제 (SSRI) + 술 = 다음날 우울 ↑ → 절대 X 권장\n• 음주 후 다음날 = 약 평소대로 + 물 많이 + 가벼운 식사\n• 약과 술 모르겠으면 = 의사한테 "회식 가는데 어떻게" 미리 문자\n• 회식 자주 = 조직장한테 "건강 사정으로 무알콜로" 사전 양해 (한 번 알리면 매번 안 거절해도 됨)\n• 진짜 절대 안 갈 회식 = 사전에 "그날 일정 있어서" 거절 (당일 X)' },
    ],
    source: 'NIH NIAAA medication-alcohol interactions; Korean ADHD treatment guidelines',
    tags: ['업무', '회식', '약'],
  },
  {
    id: 'work-camera-on',
    title: '화상 회의 카메라 켜기 부담될 때',
    category: 'work',
    summary: '환경 미리 셋업 → 카메라 ON 마찰 ↓.',
    addedAt: '2026-05-03',
    sections: [
      { icon: '😔', title: '문제', body: '화상 회의에서 카메라 켜기 = 매번 큰 부담.\n외모·배경·집·표정 동시 신경 = 인지 부하 ↑↑.\nADHD + RSD = "내 얼굴 어떻게 보이지" 자기 모니터링 = 회의 내용 못 들음.\n매번 "오늘은 카메라 OFF" 핑계 → 신뢰 ↓ + 평가 ↓ 위험.' },
      { icon: '💡', title: '해결', body: '카메라 켜기 자체를 = 결정 마비 X 자동화하기.\n환경 = 한 번 셋업 → 매번 그대로 (조명·배경·옷·각도).\n자기 화면 보기 = OFF 옵션 (Zoom·Teams 다 있음) → 자기 모니터링 부담 ↓.\n첫 5분만 켜고 = "잠깐 화면 공유" 핑계로 OFF 도 OK.' },
      { icon: '🎯', title: '예시', body: '• 환경 한 번 셋업 (한 번이면 끝):\n  - 카메라 위치 = 눈높이 (책 받침대 활용)\n  - 조명 = 정면에서 (창문 등 뒤 X)\n  - 배경 = 단순한 벽 or 깔끔한 책장\n  - 가상 배경 X = 자연스러운 느낌\n• 회의 옷 = 미리 정해둠 (매번 결정 X) — 같은 셔츠 3벌 구매\n• Zoom = "내 비디오 숨기기" 옵션 켜기 = 자기 모니터링 부담 ↓\n• 음 소거 ON 디폴트 + 발언할 때만 OFF\n• 회의 시작 5분 전 = 거울 한 번 보고 = 끝 (회의 중엔 자기 화면 안 보기)\n• 카메라 ON 부담 = "오늘 컨디션이..." 솔직 양해 1번은 OK\n• 정기 1:1 = 매번 같은 시간 = 환경 한 번 잡으면 매번 자동\n• 헤드폰 + 음 좋은 마이크 = 시각보다 청각으로 신뢰 ↑ (얼굴 보다 목소리)' },
    ],
    source: 'Zoom fatigue research (Stanford); ADHD remote work guides',
    tags: ['업무', '화상회의', '리모트'],
  },
  {
    id: 'work-perf-review-rsd',
    title: '인사고과 받고 RSD 폭발할 때',
    category: 'work',
    summary: '24시간 룰 + 객관 자료 + 1명 안전 친구.',
    addedAt: '2026-05-03',
    sections: [
      { icon: '😔', title: '문제', body: '인사고과·평가 받음 = 단어 1개에 RSD 폭발.\n"성장 필요" 1줄 = "나는 무능해" 까지 자동 확장.\n그날 일·잠·관계 다 망가짐 + 1주일 우울.\n혼자 곱씹기 → 객관성 잃음 → 그만두고 싶음 → 충동적 결정 위험.' },
      { icon: '💡', title: '해결', body: '24시간 룰 — 평가 받은 그날엔 = 답·결정·반응 X.\n평가 다음날 = 객관 자료 (지난 1년 본인 성과 리스트) 옆에 두고 다시 읽기.\n안전한 친구·코치 1명한테 = 평가 그대로 보여주기 → 객관 시각.\n진짜 평가 vs 본인 RSD 해석 = 분리하기.' },
      { icon: '🎯', title: '예시', body: '• 평가 받은 그날 = 무조건 일찍 퇴근 + 좋아하는 음식 + 일찍 잠\n• 평가 답·이의제기 = 절대 X 24시간 안에\n• 다음날 = 평가 글 그대로 + 본인 1년 성과 리스트 = 둘 같이 보기\n• "이 평가의 어디까지가 = 진짜 / 어디부터 = 내 RSD 해석" 분리\n• 친구·멘토한테 = 평가 그대로 보여주기 ("이거 진짜 나쁜 평가야?") → 객관 시각\n• 평가 단어 분석: "성장 필요" = 다음에 더 잘하면 됨 / "심각한 문제" = 다른 의미. 단어 정확히 보기\n• 다른 동료 평가 받았는지 물어보기 = "다 비슷하게 받았다" = 너 문제 X 회사 문화\n• 진짜 받아들일 부분만 = 작은 행동 1개로 옮기기 (예: "회의 발언 늘리기" → "다음 회의 1번 발언")\n• 충동적 퇴사 결정 = 1개월 후 다시 = 그때도 같으면 진심\n• 매년 평가 시즌 = 미리 준비 (10월부터 = 본인 성과 매월 정리)' },
    ],
    source: 'RSD coping research; performance review psychology',
    tags: ['업무', '평가', 'RSD'],
  },
  {
    id: 'work-remote-isolation',
    title: '재택근무인데 일·휴식 경계 망가질 때',
    category: 'work',
    summary: '시간 X → 환경·옷·장소로 모드 전환.',
    addedAt: '2026-05-03',
    sections: [
      { icon: '😔', title: '문제', body: '재택근무 = 출근·퇴근 시간 사라짐 → 항상 일 모드 + 항상 휴식 모드.\nADHD = 시간으로 모드 전환 어려움 + 환경 자극 약함 → 일도 휴식도 어중간.\n저녁 9시까지 일 + 다음날 시동 X 악순환.\n외로움 + 동료 부재 = 동기·피드백 ↓.' },
      { icon: '💡', title: '해결', body: '시간 X = 환경·옷·장소로 모드 전환 신호.\n일 시작 = 출근 옷 + 같은 음악 + 카페·서재 같은 정해진 자리.\n일 끝 = 의식적 마무리 (책상 정리·운동복 갈아입기·산책).\n격리 방지 = 주 1회 카페 작업 + 동료와 영상 점심.' },
      { icon: '🎯', title: '예시', body: '• 출근 의식 = 옷 갈아입기 (잠옷 X) + 가벼운 산책 (10분) + 자리 앉기\n• 일 시작 음악 = 같은 플레이리스트 (조건 반사)\n• 책상·노트북 = 일 전용 (저녁엔 노트북 다른 방 가져가기)\n• 점심 = 진짜 휴식 = 폰 X + 진짜 식사 + 산책\n• 퇴근 의식 = 책상 정리 + 운동복 갈아입기 + "퇴근" 한 마디 큰 소리로\n• 주 1회 = 카페·도서관·코워킹 = 환경 자극 ↑\n• 동료와 = 주 1회 화상 점심 (친한 1~2명)\n• 회사 단톡방·디스코드 = 잡담 채널 적극 참여 (온라인 자판기)\n• 명확한 근무 시간 정함 (예: 9~18시) = 그 외엔 슬랙 OFF\n• 운동 = 매일 (재택 = 신체 활동 0 위험) — 점심 후 산책 의무화' },
    ],
    source: 'Remote work productivity research; ADHD remote work guides',
    tags: ['업무', '재택', '리모트'],
  },
  // ── 🎯 집중 (추가 2026-05-04) ──────────────────────
  {
    ...
    title: '폰을 30초마다 잡을 때',
    category: 'start',
    summary: '의지 X → 물리 거리 + 잠금 앱.',
    addedAt: '2026-05-04',
    sections: [
      { icon: '😔', title: '문제', body: '집중하려고 앉으면 = 30초 안에 폰 잡음.\n10분에 5번 폰 → 그날 진짜 일 = 0.\nADHD = 도파민 굶주림 → 폰 = 가장 빠른 도파민 = 자동 손이 감.\n"오늘은 폰 안 봐" 의지 = 매일 무너짐.' },
      { icon: '💡', title: '해결', body: '의지로 X — 환경으로.\n물리적 거리 = 폰을 다른 방·서랍·잠긴 박스에.\n잠금 앱 = Forest·Cold Turkey·OnePlus Zen Mode = 일정 시간 앱 차단.\n진짜 급한 연락 = 워치만 on (전화·텍스트만 알림).' },
      { icon: '🎯', title: '예시', body: '• 책상 = 폰 절대 X. 다른 방 / 가방 / 서랍\n• 가족·룸메이트한테 = "이 시간엔 내 폰 안 보여줘" 부탁\n• Forest 앱 = 시간 정해서 식물 키우기 (앱 보면 식물 죽음 — 시각 페널티)\n• Cold Turkey (Mac/Win) = SNS·유튜브 url 차단\n• 안드로이드 디지털웰빙 = 앱별 시간 제한\n• iOS Screen Time = 앱 잠금 (비밀번호 가족한테)\n• 워치 (애플·갤럭시) = 전화·텍스트만 ON, SNS 알림 OFF\n• 자기 전 = 폰 거실에 두고 침실 X\n• 아침 = 알람 끄려면 일어나서 가야 = 폰 멀리\n• 자투리 시간 = 책 1챕터·산책 = 폰 대안 미리 정해두기' },
    ],
    source: 'Adam Alter "Irresistible"; ADHD digital addiction research',
    tags: ['집중', '폰', '환경'],
  },
  {
    id: 'first-minute-magic',
    title: '시작만 하면 계속하는데 = 그 첫 1분',
    category: 'start',
    summary: '"5분만" 보다 = "1분만" 룰 + if-then 미리 약속.',
    addedAt: '2026-05-04',
    sections: [
      { icon: '😔', title: '문제', body: '일단 시작하면 = 1시간도 깊이 빠지는데 = 첫 1분이 죽도록 어려움.\nADHD = 시작 마비 (executive dysfunction) — 능력 X 의지 X 시동 회로 차이.\n"오늘 해야지" → 30분 멍 → 또 미룸.\n결국 = 일 못 한 게 아니라 = 시작 못 한 거.' },
      { icon: '💡', title: '해결', body: '"5분만" 도 길어 — "1분만" 룰 = 1분 후 그만둘 수 있음.\nIf-Then 약속 미리 = "X 일 일어나면 → Y 시작" (Gollwitzer 연구).\n같은 자리·같은 시간·같은 의식 = 자동 시동 (조건 반사).\n첫 1분 = 가장 작은 행동 (앱 열기·노트 펼치기·한 줄 쓰기).' },
      { icon: '🎯', title: '예시', body: '• "1분만" 타이머 + "1분 후 멈춰도 OK" 자기 약속\n• If-Then 예시: "9시 알람 울리면 → 노트북 열기" (열기까지만!)\n• 첫 행동 = 가장 작게 ("문서 열기" "한 단어 쓰기" "운동복 갈아입기")\n• 같은 자리 매일 = 책상 = 일 전용. 침대 X 소파 X\n• 시작 음악 = 같은 곡 매번 (조건 반사)\n• 시작 직전 = 물 한 잔 + 깊은 호흡 1번\n• 1분 지나면 = 자연스레 5분·10분 됨 (대부분)\n• 1분 진짜 못 시동 = 그날은 컨디션 ↓ 신호. 진짜 쉬어\n• "오늘 못 했다" 자책 X — 신경 회로 차이지 의지 X' },
    ],
    source: 'Gollwitzer implementation intentions; ADHD task initiation research',
    tags: ['집중', '시작'],
  },
  {
    id: 'internet-block',
    title: 'SNS·유튜브 자기도 모르게 1시간 갈 때',
    category: 'start',
    summary: '의지로 X → 강제 차단 도구로.',
    addedAt: '2026-05-04',
    sections: [
      { icon: '😔', title: '문제', body: '"인스타 1분만" → 1시간 후 정신 차림.\n자기도 모르게 손이 갔고, 자기도 모르게 1시간 흘렀음.\nADHD = 도파민 회로가 SNS·유튜브 알고리즘이랑 = 가장 잘 맞음 = 가장 위험.\n매번 자기 비난 → 다음에 또 같음.' },
      { icon: '💡', title: '해결', body: '자기 의지 = 못 이김 (정직하게). 도구로 강제 차단.\n시간 정해서 = 그 시간엔 SNS·유튜브 url 자체 차단.\n"풀어달라" 누르면 = 30초·5분 대기 = 충동 식는 시간.\n잠금 앱 = 자기 비밀번호 X = 다른 사람한테 (룸메이트·친구).' },
      { icon: '🎯', title: '예시', body: '• 데스크탑: Cold Turkey Blocker (Mac·Win) — 가장 강력. SNS·뉴스·유튜브 차단\n• 모바일: ScreenZen (iOS) / 디지털웰빙 (안드) = 앱별 시간 제한\n• Forest = 식물 키우기 (시각 페널티 = 약하지만 입문용 OK)\n• Freedom = 멀티 디바이스 동시 차단 (구독)\n• Chrome 익스텐션 = StayFocusd / BlockSite\n• 잠금 비밀번호 = 친구·가족이 보관 (자기가 못 풀게)\n• 알고리즘 무력화 = 인스타·유튜브 = 추천 피드 X 검색 only 모드\n• 폰 홈 화면 = SNS 앱 다 폴더 안 (한 번 더 클릭 = 충동 줄어듦)\n• 흑백 모드 = 색이 빠지면 = 도파민 ↓ (실제 효과)\n• "오늘 1시간 SNS 갔다" 자책 X = 도구 못 갖춘 거. 다음엔 도구 추가' },
    ],
    source: 'Tristan Harris "Time Well Spent"; ADHD digital habit research',
    tags: ['집중', 'SNS', '차단'],
  },
  {
    id: 'micro-task-time',
    title: '자투리 10~15분 그냥 흘려보낼 때',
    category: 'start',
    summary: '"이 시간 뭐 하지" 결정 X → 미리 짠 마이크로 리스트.',
    addedAt: '2026-05-04',
    sections: [
      { icon: '😔', title: '문제', body: '회의 사이 15분, 약속 30분 전, 점심 후 10분 = "뭐 할까" 결정 X = 폰 1시간.\nADHD 결정 마비 + 짧은 시간 = "큰 일 시작 못 함" 자기 합리화 = 폰만.\n자투리 시간 = 누적하면 하루 1~2시간 = 1주 10~15시간 = 큰 자산.\n결국 = "시간 없어" 라고 말하는데 = 자투리 시간만으로도 작은 일 다 됨.' },
      { icon: '💡', title: '해결', body: '미리 만든 "마이크로 태스크 리스트" — 5/10/15분 단위.\n자투리 = 결정 X = 리스트에서 시간 맞는 거 1개 골라 시작.\n각 마이크로 태스크 = 끝낼 수 있는 사이즈 (서류 1장·메일 1통·연락 1번).\n작은 거 끝낸 도파민 = 다음 일 시작 마찰 ↓.' },
      { icon: '🎯', title: '예시', body: '• 노션·메모 앱에 "마이크로 태스크" 리스트 미리\n• 5분: 메일 1통 답·약 먹기·물 마시기·메모 정리·청구서 결제\n• 10분: 책상 정리·세탁기 돌리기·짧은 글 쓰기·운동 1세트\n• 15분: 예약 전화·과제 1챕터·이메일 batch·필요한 거 인터넷 주문\n• 장보기 리스트·읽을 책·해야할 연락 = 미리 적어두기\n• 자투리 = 폰 X = 리스트 보고 1개 시작\n• 끝나면 = 체크 (도파민 hit)\n• 하루 자투리 = 진짜 합치면 1~2시간 (계산해보면 충격)\n• 큰 일 시작 마찰 ↓ 효과 있음 — 작은 거 했으니까 큰 거도\n• 안 적어두면 = 진짜 그 순간엔 아무것도 안 떠올라' },
    ],
    source: 'David Allen GTD; ADHD task batching research',
    tags: ['집중', '자투리', '시간'],
  },
  {
    id: 'big-project-elephant',
    title: '1주일 ↑ 큰 프로젝트 1년째 안 시작될 때',
    category: 'start',
    summary: '"코끼리 한 번에 X" → 매일 30분 의식.',
    addedAt: '2026-05-04',
    sections: [
      { icon: '😔', title: '문제', body: '"이력서 정리", "포트폴리오", "사업 시작", "책 쓰기" — 1년째 머리에만.\n작은 일 (메일·청구서) 은 잘 하는데 = 큰 프로젝트만 못 함.\nADHD time blindness + 큰 사이즈 부담 = "내일부터" 영원.\n결국 = 친구·동료가 먼저 끝낸 거 보고 자기혐오.' },
      { icon: '💡', title: '해결', body: '코끼리 = 한 번에 못 먹어 = 매일 한 입씩.\n매일 같은 시간 30분 의식 = 더 안 하고 더 안 빠지기.\n"1주 안에 절반" 같은 큰 마감 X = "오늘 30분만" 작은 마감.\n6개월 후 = 자연스레 끝남. 처음엔 안 보이지만 = 누적의 마법.' },
      { icon: '🎯', title: '예시', body: '• 큰 프로젝트 = 매일 30분 = 같은 시간 (예: 출근 전 7~7:30)\n• 30분 알람 = 시작·끝 둘 다 = 더 안 하고 더 안 빠지기\n• 첫 30분 = 분해·계획 = 작은 단계 10개 (각 5~10분)\n• 매일 1~2개 단계 = 30분 안에\n• 매주 = 진척 확인 + 다음주 단계 갱신\n• "오늘 30분 못 했다" = OK. 다음날 다시\n• 친구·코치한테 = "매일 30분 X 한다" 선언 (책임감 ↑)\n• 30분 X 90분 X 4시간 = 90분이 가장 ADHD 친화 (집중·휴식 사이)\n• 6개월 = 매일 30분 = 누적 90시간 = 거의 모든 큰 프로젝트 끝\n• 시작 못 하면 = 30분 → 10분 → 1분 = 단계적 단축. 1분이라도 매일' },
    ],
    source: 'Atomic Habits (Clear); ADHD long-term project research',
    tags: ['집중', '프로젝트', '습관'],
  },
  {
    id: 'routine-flexible',
    title: '매일 컨디션 달라서 루틴 못 만들 때',
    category: 'start',
    summary: '엄격한 루틴 X → 핵심 1개만 고정 + 나머지는 자유.',
    addedAt: '2026-05-04',
    sections: [
      { icon: '😔', title: '문제', body: '아침 6시 기상·운동·명상·일기·아침식사 = 1주일 후 = 무너짐.\nADHD = 매일 컨디션 다름 (생리·약·잠·날씨) = 엄격 루틴 = 못 따름.\n무너지면 = "나는 의지 X" 자책 → 다음 시도도 X.\n결국 = 루틴 자체를 포기.' },
      { icon: '💡', title: '해결', body: '엄격한 풀 루틴 X — 핵심 1개만 고정.\n나머지 = 그날 컨디션 따라 자유롭게.\n핵심 1개 = "어쨌든 매일" 단순한 거 (예: 아침 약 먹기·물 1잔·이불 정리).\n80% 만 지키면 OK. 100% 강박 = ADHD 안 맞음.' },
      { icon: '🎯', title: '예시', body: '• 핵심 1개 후보 (단순+빠름):\n  - 아침 약 먹기 (물 1잔)\n  - 침대 정리\n  - 양치 (자기 전·아침)\n  - 매일 한 줄 일기\n• 그 1개만 = 어떤 컨디션에서도 가능\n• 1개 정착되면 = 6개월 후 1개 추가\n• 매일 똑같이 X = "월수금만"·"기상 1시간 안에" 같이 유연\n• 무너진 날 = "내일 다시" 만 적기. 자책 X\n• 컨디션 표시 = 핵심 옆에 1~5점 매일 (low 일 땐 자책 X)\n• 아침 일찍 못 일어나는 날 = 핵심 1개 = 점심까지 끝내면 OK\n• 같은 시간·장소 = 도움 ↑ but 강박 X\n• "아침형 인간" 강박 X — 본인 자연스러운 시간대 받아들이기' },
    ],
    source: 'Tiny Habits (Fogg); ADHD routine research',
    tags: ['집중', '루틴', '습관'],
  },
  {
    id: 'afternoon-slump',
    title: '오후 2~4시 슬럼프 살아남기',
    category: 'start',
    summary: '약 효과 ↓ 시간 = 가벼운 일·이동·식사 buffer.',
    addedAt: '2026-05-04',
    sections: [
      { icon: '😔', title: '문제', body: '아침은 잘 됐는데 오후 2~4시 = 머리 안 돔.\n자극제 (콘서타 8~10시간) 효과 떨어지는 시간 + 점심 후 혈당 = 더블 슬럼프.\n중요 회의·결정 = 이 시간에 잡히면 = 망함.\n억지로 하다 = 더 비효율 + 저녁까지 끌려감.' },
      { icon: '💡', title: '해결', body: '오후 슬럼프 = 싸우지 말고 = 받아들이고 일정 조정.\n이 시간 = 가벼운 일 (메일 답장·잡일·이동·운동·산책).\n중요 일 = 오전·저녁으로 이동.\nPower nap (20분) = 진짜 효과 — 부끄러워 X.' },
      { icon: '🎯', title: '예시', body: '• 오전 = 가장 어려운 일 1개 (회의·기획·창작)\n• 오후 2~4시 = 메일·잡일·이동·운동·청소\n• Power nap 20분 = 알람 정확히 (더 자면 역효과)\n• 산책 10~15분 = 빠른 회복\n• 점심 = 탄수 적게 + 단백질 ↑ (혈당 슬럼프 ↓)\n• 카페인 = 오후 2시 이전만 (그 후 = 잠 영향)\n• 자극제 추가 (Booster) = 의사와 상의 (오후 약 추가)\n• 회의 = 가능한 오전·5시 이후로 잡기\n• 5시 이후 = 다시 깨어나는 ADHD 많음 — 그 시간 활용\n• 매일 같은 슬럼프 시간 = 일정에 미리 박아두기 (자기 패턴 인정)' },
    ],
    source: 'ADHD circadian + medication research; Brooks & Lack power nap study',
    tags: ['집중', '오후', '슬럼프'],
  },
  {
    id: 'executive-dysfunction-self',
    title: '"할 수 있는데 못 하는" 자기 비난 끊기',
    category: 'start',
    summary: '의지 X 신경 회로 차이 → 자기 비난 그만, 도구로 우회.',
    addedAt: '2026-05-04',
    sections: [
      { icon: '😔', title: '문제', body: '"이거 5분이면 되는데 왜 못 하지" 자기 비난 매일.\nADHD executive dysfunction = "할 수 있는데 못 함" — 능력·의지 둘 다 있는데 시동 X.\n자기 비난 → 우울 → 더 못 함 → 더 자책 = 악순환.\n부모·친구·동료 말 = "그냥 하면 되잖아" — 더 깊은 상처.' },
      { icon: '💡', title: '해결', body: '의지 문제 X = 신경 회로 차이 (전두엽·도파민) — 의학적 사실.\n자기 비난 그만 → 그 에너지로 = 우회 도구 찾기.\n작은 외부 자극 (알람·바디더블링·실시간 보고) = 시동 회로 도와줌.\n친구·코치·약 = 다 정당한 도움. 혼자 하라는 강박 X.' },
      { icon: '🎯', title: '예시', body: '• 자기 비난 들어오면 = "이건 ADHD 회로지 내 문제 X" 1줄 메모\n• Russell Barkley·Hallowell 영상 1번 보면 = 자책 ↓ (과학적 설명)\n• 우회 도구:\n  - 알람·타이머 (외부 시간 감각)\n  - 바디 더블링 (옆에 누군가 = 시동 ↑)\n  - 친구한테 "지금 시작했어" 보고 (책임감)\n  - 약 (자극제·항우울제) = 시동 회로 직접 보조\n  - 코치·치료사 = 외부 구조\n• "그냥 해" 는 ADHD엔 안 통함. 환경 바꿔야 함\n• 작은 일 못 하는 거 = 우울·번아웃 신호일 수도 (의사한테)\n• 자기 비난 자주 오면 = ADHD 진단·상담 (한국 진단율 낮음, 받아볼 가치 ↑)\n• 못 한 일 보다 = 한 일 카운트 (작아도) → 자존감 회복\n• ADHD 친구·커뮤니티 = "나만 그런 거 아냐" 깨달음 = 가장 큰 회복' },
    ],
    source: 'Russell Barkley executive function research; Hallowell ADHD acceptance work',
    tags: ['집중', '자기비난', '회복'],
  },
]
