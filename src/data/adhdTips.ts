...
export const ADHD_TIPS: AdhdTip[] = [
  {
    ...
    body: 'ADHD 시작 장벽은 의지·게으름 X, 도파민 회로가 "이거 보상돼" 신호를 못 띄워서. 매번 의지 끌어모으는 거 진짜 어려움.\n\n해결 = 결정 한 번 하고 환경이 자동으로 끌고 가게.\n\n📌 환경 디자인 = 매번 의지로 결정 안 하게 환경에 박아두는 셋업. 동선·도구·알람으로 자동 유도.\n• 퇴근 후 운동 못 감 → 직장 근처 헬스장 끊기 (퇴근 동선에 박힘)\n• 책상 앞에 못 앉음 → 단골 카페 만들기 (그 카페 = 공부 모드 자동 트리거)\n• 약 매번 까먹음 → 침대 옆 약통 + 11pm 알람\n• 아침 운동 → 어젯밤 운동복 침대 옆에 꺼내두기\n\n📌 미세 행동 = 5초 안에 끝낼 첫 동작 1개. 부담 ↓ + 관성 켜기.\n• 공부 → "노트북 열고 그 폴더 클릭" (3초)\n• 청소 → "책상 위 컵 1개만 싱크대로"\n\n첫 행동 끝나면 관성으로 다음 5분 자동 시작. "전체"를 시작하려 하지 말고 "첫 클릭"만.',
