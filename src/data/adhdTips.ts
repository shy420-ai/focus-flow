...
export const ADHD_TIPS: AdhdTip[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { icon: '💡', title: '해결', body: '하루 컨디션·작업 종류 보고 매번 비율 바꾸기.\n오전 = 깊은 작업 90/20, 오후 = 50/10.\n시동 안 걸리는 날 = 애니메도로, 컨디션 좋은 날 = 흐름타임.\n비율 강박 X — 매일 자기한테 "지금 몇 분 OK?" 물어.' },
      { icon: '⏱', title: '비율로 고르는 6가지', body: '⚡ 5분 일 / 1분 휴식 — 응급용\n시동이 0%인 날, "5분만 해보자" 로 시작. 5분 끝나면 자연스럽게 10·15분 더 갈 수 있음. 책상에 앉기조차 힘든 날 자기 속이는 용도.\n\n🍿 22분 일 / 22분 휴식 — 애니 1화 보상 (애니메도로)\n의대생 유튜버가 만든 방식. 22분 빡세게 일하고 애니 1화 (정확히 22~24분) 보기. 보상이 크고 명확해서 도파민에 잘 맞음. 시동 안 걸리는 날 응급용.\n\n🍅 25분 일 / 5분 휴식 — 원조 클래식\n이탈리아 학생이 토마토 모양 부엌 타이머로 만든 원조 (Pomodoro = 토마토). 입문용으로 쉽고 짧은 작업·이메일·정리에 적합.\n\n📅 50분 일 / 10분 휴식 — ADHD 데일리 추천\n25분은 시동 걸리는 순간 끝나서 오히려 짜증. 50분이면 시동 + 깊이 + 마무리까지. ADHD 데일리 루틴에 가장 잘 맞는 비율로 알려져 있음.\n\n💼 52분 일 / 17분 휴식 — 직장인용 (데이터 기반)\n시간 추적 앱이 100만 명 사용자를 분석한 결과, 상위 10% 생산성 가진 사람들이 평균 52분 일하고 17분 쉬었음. 회사 8시간 근무 단위에 잘 맞아.\n\n🌊 90분 일 / 20분 휴식 — 깊은 작업용\n인체 집중 사이클이 약 90분 주기로 출렁인다는 수면 연구 기반. 글쓰기·코딩·논문처럼 진짜 깊이 들어가야 하는 작업용. 하루 3사이클이 한계 — 그 이상은 번아웃.' },
      { icon: '🧭', title: '방법론 4가지', body: '🎢 흐름타임 — 타이머 X, 자기 페이스대로\n자연스럽게 시작 → 자연스럽게 끝 → 일한 시간의 1/4만큼 쉼.\n예: 44분 일했으면 11분 쉼.\n컨디션 매일 출렁이는 ADHD에게 강제 비율보다 자기 페이스 존중. 휴식 시간만 알람 켜 (휴식 폭주 방지).\n\n📦 시간 박스 — 하루 미리 짜기\n"딥워크" 저자 칼 뉴포트 방식. 하루를 박스 단위로 미리 결정.\n예: 9-10 기획서, 10-12 회의, 13-15 코딩.\n작업 전환 비용 ↓, "다음에 뭐하지?" 결정 피로 ↓. 미리 짜는 걸 좋아하는 사람용.\n\n🐸 가장 어려운 일 먼저 — 미루기 차단\n자기계발 작가 브라이언 트레이시의 핵심 메시지: "개구리부터 먹어라."\n하루 첫 1시간엔 가장 어렵고 미루고 싶은 일을 무조건 먼저.\n의지력은 아침이 최대 → 어려운 일 끝내고 나면 그날 나머지가 다 쉬워 보임.\n\n👥 같이 있어주기 — 옆에 누가 있으면 시작됨\nADHD 특유 현상: 혼자선 못 시작하지만 누가 옆에 있으면 신기하게 시동 걸림.\n방법: 줌으로 친구랑 같이, 카페·도서관 가기, 포커스메이트 같은 화상 같이 공부 서비스 쓰기.\n말 안 해도 됨 — 존재 자체가 도움.' },
      { icon: '🎯', title: '내 상황별 추천', body: '📅 매일 루틴 (꾸준함 우선) → 50/10\n📚 깊은 작업 (논문·기획·코딩) → 90/20\n😩 시동 안 걸리는 날 → 애니메도로 22/22 또는 5/1\n🎢 하루마다 컨디션 출렁 → 흐름타임\n💼 회사 8시간 단위 → 52/17\n📦 미리 짜는 거 좋아함 → 시간 박스\n😫 미루기 심한 날 → 가장 어려운 일 먼저\n🥺 혼자 못 시작 → 같이 있어주기\n\n조합 OK:\n• 오전 = 90/20 → 오후 = 애니메도로\n• 평일 = 50/10 → 주말 = 흐름타임\n• 첫 사이클 = 애니메도로 (시동) → 다음 = 50/10\n\n핵심: "정답 비율" X = 매일 컨디션 맞춰 바꾸는 유연성.\n그날 안 되는 비율 = 그날만 다른 비율로 — 강박 X.' },
    ],
  ...
  // ── 📚 학습 — 뽀모도로 시리즈 5~10 (추가 2026-05-04) ──────────────
  {
    id: 'pomo-micro-5-1',
    title: '뽀모도로 기법 5 — Micro 5/1 (진짜 시동 안 걸리는 날)',
    category: 'study',
    summary: '5분도 길 때 = 5분 일 / 1분 휴식. 시동 0.',
    addedAt: '2026-05-04',
    sections: [
      { icon: '😔', title: '문제', body: '50/10도 25/5도 22/22도 다 부담스러운 날.\nADHD 컨디션 ↓ + 약 효과 ↓ + 우울 동반 시 = 5분도 길게 느껴짐.\n결국 = 시작 못 하고 0분 = 자책 더 깊음.' },
      { icon: '💡', title: '해결', body: 'Micro Pomo = 5분 일 / 1분 휴식 / 5분 일 / 1분 휴식 ...\n6분 사이클이 = 가장 작은 단위. 못 시동 = 다음 6분 또 시도.\n10사이클 = 1시간 일 한 셈. 0보다 무조건 ↑.' },
      { icon: '🎯', title: '예시', body: '• 컨디션 ↓ 인 날·생리·약 효과 ↓ · 번아웃 회복기 응급용\n• 5분 = 가장 쉬운 1개 (이메일 1통·문서 1줄·운동 1세트)\n• 1분 휴식 = 진짜 1분 (폰 X, 물 한 잔)\n• 매 사이클 = 다른 작업 OK (집중 안 되는 날 = 다양성 ↑)\n• 6사이클 (36분) = 자기 칭찬 + 휴식 5분\n• 매일 X — 진짜 안 될 때만 응급. 일상 X 22/22 또는 50/10\n• 이거라도 = "오늘 하나는 했다" 자존감 회복' },
    ],
    source: 'Adapted from Pomodoro Technique; ADHD micro-task research',
    tags: ['학습', '뽀모도로', '응급'],
  },
  {
    id: 'pomo-52-17',
    title: '뽀모도로 기법 6 — 52/17 (직장인 데이터 기반)',
    category: 'study',
    summary: '데이터로 입증된 직장인 최적 비율.',
    addedAt: '2026-05-04',
    sections: [
      { icon: '😔', title: '문제', body: '50/10·90/20 다 ADHD 사이트에서 들었지만 = 실제 직장 회의·메일 흐름엔 안 맞음.\n출근 후 첫 1시간 깊은 일 못 하고 회의 들어가면 = 사이클 깨짐.\n뽀모도로는 = 책상에 계속 앉아있는 사람 기준 → 직장인 안 맞음.' },
      { icon: '💡', title: '해결', body: '52/17 = DeskTime 회사가 100만 명 데이터 분석한 최적 비율 (2014).\n52분 일 + 17분 진짜 휴식 (자리 떠남).\n직장인 평균 attention curve 에 가장 잘 맞음.\n17분 휴식 = 산책·물·진짜 식사 가능 (진짜 회복).' },
      { icon: '🎯', title: '예시', body: '• 출근 직후 첫 52분 = 가장 어려운 일 (회의 ↓ 시간대)\n• 17분 휴식 = 자리 떠남 (책상 X) — 산책·화장실·물·간식\n• 회의 사이 자투리 시간 = 못 쓰면 = 그날 사이클 X 받아들임\n• 점심 후 = 다시 52/17 시작\n• 하루 4사이클 = 깊은 일 3.5시간 (직장인 한계)\n• ADHD 자극제 효과 시간 (콘서타 6~10h) 안에 = 4사이클 끝내기\n• Slack·메일 = 17분 휴식 시간에만 (52분 안엔 OFF)\n• 회의 직후 = 17분 reset (바로 일 시작 X)' },
    ],
    source: 'DeskTime 2014 productivity study; corporate ADHD research',
    tags: ['학습', '뽀모도로', '직장'],
  },
  {
    id: 'pomo-timeboxing',
    title: '뽀모도로 기법 7 — Time Boxing (Cal Newport)',
    category: 'study',
    summary: '시간을 박스 단위로 미리 짜둠 → 결정 마비 0.',
    addedAt: '2026-05-04',
    sections: [
      { icon: '😔', title: '문제', body: '뽀모도로 = "지금 뭐 할까" 결정은 안 도와줌.\nADHD 결정 마비 = 25분 시작했는데 = 뭐 할지 5분 동안 멍.\n사이클은 돌아가는데 = 진짜 진척 0.\n하루 끝 = "뭐 했지" 모름.' },
      { icon: '💡', title: '해결', body: 'Time Boxing = 하루 시작 = 모든 시간을 박스 단위로 미리 짜기.\n예: 9~10 = 메일 / 10~11:30 = 기획서 / 11:30~12 = 회의\n각 박스 안에서 = 다른 일 X. 결정 마비 0.\nCal Newport = "Deep Work" 핵심 기법.' },
      { icon: '🎯', title: '예시', body: '• 매일 아침 5분 = 하루 박스 짜기 (종이·노션·일간 탭)\n• 박스 단위 = 30분 / 60분 / 90분 (작업 무게에 따라)\n• 박스 = 한 가지 일만 (멀티태스킹 X)\n• 박스 끝 = 그 박스 결과 한 줄 메모\n• 박스 안에 휴식·이동 시간 다 포함 (현실 시간)\n• 회의 = 박스로 명시 (그 시간엔 다른 일 X)\n• 못 끝낸 거 = 다음날 박스로 옮김\n• ADHD time blindness 보완 = 박스 = "이 시간엔 이거 한다" 결정 자동\n• 포플 일간 탭이 = 정확히 time boxing 구현. 활용 ↑\n• Elon Musk = 5분 박스 (극단). ADHD엔 30~60분 권장' },
    ],
    source: 'Cal Newport "Deep Work"; Time-Boxing methodology',
    tags: ['학습', '뽀모도로', '계획'],
  },
  {
    id: 'pomo-eat-the-frog',
    title: '뽀모도로 기법 8 — Eat the Frog (가장 어려운 일 첫 시간에)',
    category: 'study',
    summary: '아침 첫 90분 = 가장 어려운 1개. 나머지 자동.',
    addedAt: '2026-05-04',
    sections: [
      { icon: '😔', title: '문제', body: '쉬운 일 (이메일·청소·정리) 만 하다가 = 진짜 중요한 일 = 매일 미룸.\nADHD = 도파민 회로 = 쉬운 일 = 즉각 보상 → 어려운 일 회피.\n결국 = 1주일 = 진짜 중요한 일 0개 진척.' },
      { icon: '💡', title: '해결', body: 'Mark Twain "아침에 살아있는 개구리를 먹으면, 그날 더 나쁜 일은 안 일어난다."\n아침 첫 90분 = 가장 어렵고 미루고 싶은 1개만.\n그 1개 끝나면 = 나머지 하루 = 가벼움 + 자존감 ↑.\n자극제 효과 피크 시간 (콘서타 = 출근 1~3시간 후) 활용.' },
      { icon: '🎯', title: '예시', body: '• 전날 밤 = "내일의 개구리" 1개 적기 (구체적 1개만)\n• 아침 출근·기상 첫 90분 = 그 1개만 (메일 X 회의 X)\n• 자극제 = 일어나자마자 = 90분 후 효과 피크\n• 휴대폰 = 다른 방 + 알림 OFF\n• 90분 안에 = 60% 진척 OK (완벽 X)\n• 못 끝내면 = 다음날 또 첫 시간에\n• "개구리" 정의: 미루고 있고 + 중요하고 + 어렵고 + 마감 가까운 1개\n• 매일 1개씩 = 1주일 5개 = 1년 250개 진척\n• "오늘 개구리 끝!" 자기 칭찬 = 도파민 회복' },
    ],
    source: 'Brian Tracy "Eat That Frog!"; Mark Twain quote',
    tags: ['학습', '뽀모도로', '우선순위'],
  },
  {
    id: 'pomo-stealth',
    title: '뽀모도로 기법 9 — Silent Pomo (알람 없는 부드러운 사이클)',
    category: 'study',
    summary: '알람 X 시각 타이머만 → 흐름 안 끊기.',
    addedAt: '2026-05-04',
    sections: [
      { icon: '😔', title: '문제', body: '뽀모도로 알람 = 일 흐름 가장 잘 들어갔을 때 = 알람으로 강제 중단.\nADHD 하이퍼포커스 = 한 번 깨지면 다시 들어가기 어려움.\n매번 알람 = 짜증 + 앱 자체 못 쓰게 됨.' },
      { icon: '💡', title: '해결', body: 'Silent (Stealth) Pomo = 알람 X. 시각 타이머만.\n시간 = 시각으로 확인 (진행 바·원형 카운트다운).\n흐름 들어갔을 때 = 자연스럽게 더 일 OK.\n자연 휴식 욕구 들 때만 = 시간 확인 후 휴식.' },
      { icon: '🎯', title: '예시', body: '• 시각 타이머: Pomofocus·Tide·Be Focused·Forest 무음 모드\n• Apple 시계 = 무음 + 진동만 (소리 X)\n• 화면 한 켠 = 작은 카운트다운 (방해 X)\n• "25분 지나면 자연스럽게 휴식 생각" 자기 신호\n• 들어갔으면 = 30·40·50분 가도 OK (강박 X)\n• 휴식 욕구 들 때 = 시계 보고 = 시간 확인 후 휴식\n• Flowtime + Silent = 가장 ADHD 친화 조합\n• 단, 시간 감각 약한 사람 = 알람 켜기 권장 (안 그러면 3시간 그냥 감)\n• Apple Watch = 진동만 (방해 ↓)' },
    ],
    source: 'Flow state research (Csikszentmihalyi); ADHD hyperfocus protection',
    tags: ['학습', '뽀모도로', '몰입'],
  },
  {
    id: 'pomo-body-doubling',
    title: '뽀모도로 기법 10 — Body Doubling 뽀모 (같이 타이머)',
    category: 'study',
    summary: '혼자 못 하면 = 줌·디스코드에 누구랑 같이.',
    addedAt: '2026-05-04',
    sections: [
      { icon: '😔', title: '문제', body: '혼자 = 시동 안 걸림 + 시간 흘러가도 모름 + 휴식 시 폰만.\nADHD 가장 강한 도구 = 다른 사람의 존재 (Body Doubling).\n혼자서 모든 뽀모도로 기법 시도 → 다 실패한 경험 흔함.' },
      { icon: '💡', title: '해결', body: 'Body Doubling Pomo = 다른 사람과 화상·통화로 같이 타이머.\n서로 일 X = 그냥 옆에 있어주기.\n25분 일 → 5분 같이 잡담 → 다시 25분 일.\n온라인 도구 (Focusmate·Flow Club·디스코드) 활용.' },
      { icon: '🎯', title: '예시', body: '• Focusmate = 50분 1:1 매칭 (모르는 사람과). 무료 3회/주\n• Flow Club = 그룹 세션 (호스트 + 5~10명) 유료\n• 디스코드 ADHD 서버 = "study together" 채널 무료\n• 친구한테 = 매주 화·목 9시 줌으로 50/10 같이\n• 가족·룸메이트 = 같은 방에서 각자 일 (말 X)\n• 카페·도서관 = 모르는 사람들 옆 = 약한 body doubling 효과\n• 화상 = 카메라 ON (얼굴 보여야 효과 ↑)\n• 일 시작 멘트 = "지금 X 시작해" 한 마디 (책임감)\n• 휴식 시간 = 잡담 (5분만)\n• 매주 같은 시간·같은 사람 = 효과 ↑ (조건 반사)\n• 본인 ADHD 단톡방 = 매일 9~10시 zoom 정기 모임 만들기' },
    ],
    source: 'ADHD body doubling research; Focusmate methodology',
    tags: ['학습', '뽀모도로', '커뮤니티'],
  },
]
