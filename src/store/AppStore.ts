...
export type CurView = 'tl' | 'week' | 'habit' | 'goal' | 'drop' | 'cal' | 'stats' | 'friends'
...
export const useAppStore = create<AppStore>()(
  immer((set, get) => ({
    ...
    curDate: todayStr(),
    curView: (['tl','week','habit','goal','drop','cal','stats','friends'].includes(localStorage.getItem('ff_cur_view') || '') ? localStorage.getItem('ff_cur_view') as CurView : 'tl'),
