...
export type CurView = 'tl' | 'week' | 'habit' | 'goal' | 'drop' | 'cal' | 'stats' | 'friends' | 'mood'
...
export const useAppStore = create<AppStore>()(
  immer((set, get) => ({
    ...
    curDate: todayStr(),
    curView: (['tl','week','habit','goal','drop','cal','stats','friends','mood'].includes(localStorage.getItem('ff_cur_view') || '') ? localStorage.getItem('ff_cur_view') as CurView : 'tl'),
